...
public class DynamicProxyFilterConfig {
    ...
    private static final String[] PATTENRS = {"reqeust*", "order*", "save*"};
    ...
    public OrderControllerV1 orderControllerV1(LogTrace logTrace) {
        ...
        return (OrderControllerV1) Proxy.newProxyInstance(OrderControllerV1.class.getClassLoader(), new Class[]{OrderControllerV1.class},
                                                          new LogTraceFilterHandler(orderControllerV1, logTrace, PATTENRS));
    }
    ...
    public OrderServiceV1 orderServiceV1(LogTrace logTrace) {
        ...
        return (OrderServiceV1) Proxy.newProxyInstance(OrderServiceV1.class.getClassLoader(), new Class[]{OrderServiceV1.class},
                                                       new LogTraceFilterHandler(orderServiceV1, logTrace, PATTENRS));
    }
    ...
    public OrderRepositoryV1 orderRepositoryV1(LogTrace logTrace) {
        ...
        return (OrderRepositoryV1) Proxy.newProxyInstance(OrderRepositoryV1.class.getClassLoader(), new Class[]{OrderRepositoryV1.class},
                                                          new LogTraceFilterHandler(orderRepositoryV1, logTrace, PATTENRS));
