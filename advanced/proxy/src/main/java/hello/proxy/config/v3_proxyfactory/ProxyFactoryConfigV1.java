...
public class ProxyFactoryConfigV1 {
    ...
    public OrderControllerV1 orderControllerV1(LogTrace logTrace) {
        ...
        log.info("OrderControllerV1 proxy : {}, target = {}", proxy.getClass(), orderControllerV1.getClass());
        return proxy;
    }
    ...
    public OrderServiceV1 orderServiceV1(LogTrace logTrace) {
        ...
        log.info("OrderServiceV1 proxy : {}, target = {}", proxy.getClass(), orderServiceV1.getClass());
        return proxy;
    }
    ...
    public OrderRepositoryV1 orderRepositoryV1(LogTrace logTrace) {
        ...
        log.info("OrderRepositoryV1 proxy : {}, target = {}", proxy.getClass(), orderRepositoryV1.getClass());
        return proxy;
    }
