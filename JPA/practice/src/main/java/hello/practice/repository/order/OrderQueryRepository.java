...
public class OrderQueryRepository {
    ...
    private List<OrderQueryDto> findOrders() {
        return em.createQuery("select new hello.practice.repository.order.OrderQueryDto(o.id, m.name, d, o.orderDate, o.status)" + " from Order o" + " join o.member m" + " join o.delivery d", OrderQueryDto.class)
                .getResultList();
    }
    ...
    private List<OrderItemQueryDto> findOrderItems(Long orderId) {
        return em.createQuery("select new hello.practice.repository.order.OrderItemQueryDto(" + "oi.order.id, i.name, oi.orderPrice, oi.count)" + " from OrderItem oi" + " join oi.item i" + " where oi.order.id = : orderId", OrderItemQueryDto.class)
